    ...
    return (
        <>
            <div class="grid h-full w-40 grid-cols-3 gap-0">
                <button class="btn btn-square btn-sm h-full w-full rounded-none border-0 bg-base-100 ">
                    <VsChromeMinimize size={18} />
                </button>
                <button class="btn btn-square btn-sm h-full w-full rounded-none border-0 bg-base-100 ">
                    <VsChromeMaximize size={18} />
                </button>
                <button class="group/btn btn btn-sm h-full w-full rounded-none border-0 bg-base-100 hover:bg-red-700">
